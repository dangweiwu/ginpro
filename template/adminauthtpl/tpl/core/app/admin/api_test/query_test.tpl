...
func TestAdminQuery(t *testing.T) {
	...
	//角色测试
	rolename := &adminmodel.AdminPo{Account: "accoun5", Name: "name5", Phone: "12345678915", Email: "email5@qq.com", Role: "admin"}
	SerCtx.Db.Create(rolename)

	rolePo := &rolemodel.RolePo{Code: "admin", Name: "superadmin"}
	SerCtx.Db.AutoMigrate(rolePo)
	SerCtx.Db.Create(rolePo)
